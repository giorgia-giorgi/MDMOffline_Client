package com.dbg.mdm_offline_client.presentation.ui.theme
...
/** WinUI / Fluent Design System tokens (light theme) — match desktop console. */
...
@Composable
fun MdmOfflineTheme(content: @Composable () -> Unit) {
    MaterialTheme(
